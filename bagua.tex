...
\draw [rotate=\i*45] [line width=\linewidth] (\r,-\w) -- (\r,\w);

\foreach \i in {0, 1, 6, 7}
\draw [rotate=\i*45] [line width=\linewidth+5] (\r,-\b) -- (\r,\b);
...
\foreach \i in {4, 5, 6, 7}
\draw [red] [rotate=\i*45] [line width=\linewidth+5] (\r,-\b) -- (\r,\b);



% \foreach \i/\a/\b/\c in {0,0,1,0, 1,0,1,1, 2,1,1,1}
%\def\a{33}

%{\a > 0}?{}:{\draw [rotate=\i*40] [line width=\linewidth] (\r,-\w) -- (\r,\w);}
