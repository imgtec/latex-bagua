...
\fill[blue]   (0, 0) arc(90:270:2);
\fill[orange] (0, 0) arc(-90:90:2);
...
\node [rotate=6*45] at (\r, 0) {1};
\node [rotate=7*45] at (\rr, \rr) {2};

\node [rotate=0*45] at (0, \r) {3};
\node [rotate=1*45] at (-\rr, \rr) {4};


\node [rotate=2*45] at (-\r, 0) {5};
\node [rotate=3*45] at (-\rr, -\rr) {6};

\node [rotate=4*45] at (0, -\r) {7};
\node [rotate=5*45] at (\rr, -\rr) {8};
